    ...
    >
      <View style={{ flex: 1, marginHorizontal: 15, marginVertical: 15 }}>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between",gap:5 }}>
          <View >
            <Pressable style={{ marginTop: 15 }} onPress={()=>navigation.navigate('Maps')}>
              <Image
          ...
          <View style={{alignSelf:'center',marginTop:30,height:'20%'}}>
            <Carousel
            ref={isCrousel}
            data={data}
            renderItem={({item,index})=>(
                 <Image source={item.imageUrl} style={{width:'100%',height:'100%',borderRadius:10}} resizeMode="contain"/>
            )}
            layout="default"
